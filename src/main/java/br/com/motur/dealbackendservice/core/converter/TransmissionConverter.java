...
public class TransmissionConverter {
    ...
    public TransmissionType fromString(String tipo) {
        ...
        // Manual
        if (!tipo.contains("auto") && (tipo.contains("manual") || tipo.contains("stick shift") || tipo.contains("standard") || tipo.contains("padrão")) || tipo.equals("mt") || tipo.contains("m/t") || tipo.contains("m") || tipo.contains(TransmissionType.MANUAL.getDisplayName().toLowerCase())) {
