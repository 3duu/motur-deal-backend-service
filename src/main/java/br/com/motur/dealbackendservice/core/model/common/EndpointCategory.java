...
public enum EndpointCategory {
    ...
    CATALOG_BRANDS("Catálogo de Marcas", ProviderBrandsEntity.class, new BrandsFinder()),
    CATALOG_MODELS("Catálogo de Modelos", ProviderModelsEntity.class, new ModelsFinder()),
    CATALOG_TRIMS("Catálogo de Versões", ProviderTrimsEntity.class, new TrimsFinder()),
